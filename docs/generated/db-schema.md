...
| `channels` | Channels / DMs / threads / showcase | serverId, name, type (channel/private/dm/thread/showcase), parentMessageId (thread = channel derived from a message), lastMessageAt, archivedAt, deletedAt |
